  ...
  return (
    <section className="h-screen w-full flex flex-col items-center justify-center relative overflow-hidden bg-slate-900 text-slate-50">
      ...
      <div className="z-10 text-center flex flex-col items-center">
        <h1 className="text-[12vw] leading-none font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white to-slate-400 select-none font-mono">
          AGENTIC
        </h1>
        <h1 className="text-[12vw] leading-none font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-t from-white to-slate-400 select-none -mt-4 sm:-mt-8 font-mono">
          WORKS
        </h1>
