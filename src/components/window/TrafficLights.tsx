...
export const TrafficLights: React.FC<TrafficLightsProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        {isGroupHovered && (
          <svg className="w-1.5 h-1.5 text-[#4D0000]" viewBox="0 0 6 6" fill="none">
      ...
      >
        {isGroupHovered && (
          <svg className="w-1.5 h-1.5 text-[#593D00]" viewBox="0 0 6 6" fill="none">
      ...
      >
        {isGroupHovered && (
          <svg className="w-1.5 h-1.5 text-[#004D00]" viewBox="0 0 6 6" fill="none">
